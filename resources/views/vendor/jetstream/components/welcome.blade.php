                    ...
                    <table class="table table-shopping">
                        <thead class="">
                            <tr>
                                ...
                                <th x-show="photoPreview">
                                    Photo Preview
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach (glob('client/images/bg/*.{jpg,png,gif}', GLOB_BRACE) as $bg)
                                <tr>
                                    <td>
                                    ...
                                    <td x-show="photoPreview">
                                        <div class="img-container text-center">
                                            <img width="150px" src="/{{ $bg }}" alt="...">
                                        </div>
                                    </td>
                                    <td class="td-name">
                                        <button class="btn btn-primary" x-on:click.prevent="$refs.photo.click()">
                                            Change
                                        </button>
